    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <a class="navbar-brand d-flex " href="#">
                    <img class=" col-sm-1 rounded-circle img-fluid" style="width: 550px; object-fit: contain;" src="/storage/image/logo.png" alt="Responsive image">
                    <h4 class="my-auto">FACULTY DIGITAL DOCUMENT SYSTEM</h4>
                </a>
